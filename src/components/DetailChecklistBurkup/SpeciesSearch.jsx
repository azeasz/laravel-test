...
function SpeciesSearch({ checklistId, onSpeciesAdd, onClose }) {
    ...
    useEffect(() => {
        const searchSpecies = async () => {
            ...
            try {
                ...
                const response = await apiFetch(`/observations/search-species?source=${source}&query=${encodeURIComponent(query.trim())}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const source = checklistId.startsWith('BN') ? 'burungnesia' : 'kupunesia';
            const response = await apiFetch(`/observations/${checklistId}/species?source=${source}`, {
                method: 'POST',
                headers: {
