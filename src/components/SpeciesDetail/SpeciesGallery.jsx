                            ...
                            <Card>
                                {mediaPaths[0] && (
                                    <CardMedia
                                        component="img"
                                        height="200"
                                        image={`${import.meta.env.VITE_API_URL}/storage/${mediaPaths[0]}`}
                                        alt={displayName}
                                    />
                                )}
                                {item.spectrogram && (
                                    <CardMedia
                                        component="img"
                                        height="100"
                                        image={`http://localhost:8000/storage/${item.spectrogram}` || `https://talinara.com/api/storage/${item.spectrogram}`}
