            ...
            DB::transaction(function () use ($request, $userId, $kupunesiaUserId, &$checklistId) {
                ...
                foreach ($faunaIds as $index => $faunaId) {
                    ...
                    $breedingTypeId = isset($breedings[$index]) && $breedings[$index] == 1
                        ? (isset($breedingTypeIds[$index]) ? $breedingTypeIds[$index] : null) 
                        : null;
                    ...
                    DB::table('fobi_checklist_faunasv2')->insert([
                        ...
                        'breeding_note' => isset($breedingNotes[$index]) ? $breedingNotes[$index] : null,
                        'created_at' => now(),
                        'updated_at' => now()
                    ]);
                ...
                foreach ($faunaIds as $index => $faunaId) {
                    // Jika breeding = 0, pastikan breeding_type_id = null untuk third DB juga
                    $breedingTypeId = isset($breedings[$index]) && $breedings[$index] == 1
                        ? (isset($breedingTypeIds[$index]) ? $breedingTypeIds[$index] : null) 
                        : null;
