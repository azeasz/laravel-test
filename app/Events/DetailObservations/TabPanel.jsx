                                    ...
                                    {showIdentifierTooltip && activeIdentifierId === identification.id && (
                                        <div className="absolute z-10 bg-white border rounded-lg shadow-lg p-3 mt-1 left-0">
                                            <div className="text-sm">
                                                <p className="font-medium">{identification.identifier_name}</p>
                                                <p className="text-gray-600">Bergabung sejak: {new Date(identification.identifier_joined_date).toLocaleDateString('id-ID')}</p>
                                                <p className="text-gray-600">Total Identifikasi: {identification.identifier_identification_count}</p>
                                            </div>
                                        </div>
                                    )}
                                </p>
