...
function ChecklistDetail() {
    ...
    const fetchChecklistDetail = async () => {
        try {
            const response = await fetch(`http://localhost:8000/api/observations/${id}`, {
                headers: {
    ...
    const handleIdentificationSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`http://localhost:8000/api/observations/${id}/identifications`, {
                method: 'POST',
                headers: {
                    'Authorization': `Bearer ${localStorage.getItem('jwt_token')}`,
    ...
    const renderMedia = () => (
        <div>
            {checklist.media_type === 'photo' ? (
                <img src={checklist.media_url} alt={checklist.scientific_name} className="w-full h-auto" />
            ) : (
                <audio controls>
                    <source src={checklist.media_url} type="audio/mpeg" />
        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-lg shadow-lg p-6">
                        <h2 className="text-xl font-semibold mb-4">Verifikasi Data</h2>
                        ...
                        <div>
                            <h3 className="font-semibold mb-2">Status Liar</h3>
                            <div className="flex gap-2">
                                <button
            ...
            <div className="mt-4">
                <button onClick={() => rateChecklist('research grade')} className="bg-green-500 text-white py-2 px-4 rounded hover:bg-green-600">
                    Research Grade
                </button>
                <button onClick={() => rateChecklist('needs ID')} className="bg-yellow-500 text-white py-2 px-4 rounded hover:bg-yellow-600">
                    Needs ID
                </button>
                <button onClick={() => rateChecklist('casual')} className="bg-gray-500 text-white py-2 px-4 rounded hover:bg-gray-600">
                    Casual
                </button>
            </div>
