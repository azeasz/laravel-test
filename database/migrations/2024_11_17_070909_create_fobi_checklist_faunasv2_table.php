...
class CreateFobiChecklistFaunasv2Table extends Migration
{
    public function up()
    {
        Schema::create('fobi_checklist_faunasv2', function (Blueprint $table) {
            ...
            $table->foreign('checklist_id')->references('id')->on('fobi_checklists_kupnes')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('fobi_checklist_faunasv2');
    }
}
