...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('taxas', function (Blueprint $table) {
            ...
            $table->text('Cname_two')->nullable();
            $table->text('Cname_three')->nullable();
            $table->text('Cname_four')->nullable();
            $table->text('Cname_five')->nullable();
            $table->text('Cname_six')->nullable();
            $table->text('Cname_seven')->nullable();
            $table->text('Cname_eight')->nullable();
            $table->text('Cname_nine')->nullable();
            $table->text('Cname_ten')->nullable();
