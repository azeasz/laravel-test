...
use App\Http\Controllers\Api\KingdomGalleryController;
use App\Http\Controllers\Api\PhylumGalleryController;
use App\Http\Controllers\Api\ClassGalleryController;
use App\Http\Controllers\Api\OrderGalleryController;
use App\Http\Controllers\Api\FamilyGalleryController;
/*
|--------------------------------------------------------------------------
| API Routes
|--------------------------------------------------------------------------
...
// Route untuk Kingdom Gallery
Route::prefix('kingdom-gallery')->group(function () {
...
// Route untuk Phylum Gallery
Route::prefix('phylum-gallery')->group(function () {
    Route::get('/', [PhylumGalleryController::class, 'getPhylumGallery']);
    Route::get('/detail/{taxaId}', [PhylumGalleryController::class, 'getPhylumDetail']);
    Route::get('/{taxaId}/similar', [PhylumGalleryController::class, 'getSimilarPhyla']);
    Route::get('/{taxaId}/distribution', [PhylumGalleryController::class, 'getPhylumDistribution']);
    Route::get('/{taxaId}/classes', [PhylumGalleryController::class, 'getClassesInPhylum']);
});

// Route untuk Class Gallery
Route::prefix('class-gallery')->group(function () {
    Route::get('/', [ClassGalleryController::class, 'getClassGallery']);
    Route::get('/detail/{taxaId}', [ClassGalleryController::class, 'getClassDetail']);
    Route::get('/{taxaId}/similar', [ClassGalleryController::class, 'getSimilarClasses']);
    Route::get('/{taxaId}/distribution', [ClassGalleryController::class, 'getClassDistribution']);
    Route::get('/{taxaId}/orders', [ClassGalleryController::class, 'getOrdersInClass']);
});

// Route untuk Order Gallery
Route::prefix('order-gallery')->group(function () {
    Route::get('/', [OrderGalleryController::class, 'getOrderGallery']);
    Route::get('/detail/{taxaId}', [OrderGalleryController::class, 'getOrderDetail']);
    Route::get('/{taxaId}/similar', [OrderGalleryController::class, 'getSimilarOrders']);
    Route::get('/{taxaId}/distribution', [OrderGalleryController::class, 'getOrderDistribution']);
    Route::get('/{taxaId}/families', [OrderGalleryController::class, 'getFamiliesInOrder']);
});

// Route untuk Family Gallery
Route::prefix('family-gallery')->group(function () {
    Route::get('/', [FamilyGalleryController::class, 'getFamilyGallery']);
    Route::get('/detail/{taxaId}', [FamilyGalleryController::class, 'getFamilyDetail']);
    Route::get('/{taxaId}/similar', [FamilyGalleryController::class, 'getSimilarFamilies']);
    Route::get('/{taxaId}/distribution', [FamilyGalleryController::class, 'getFamilyDistribution']);
    Route::get('/{taxaId}/genera', [FamilyGalleryController::class, 'getGeneraInFamily']);
});
...
// User Observation Management Routes
use App\Http\Controllers\Api\FobiUserObservationController;

Route::middleware(['jwt.verify'])->group(function() {
    Route::prefix('user-observations')->group(function() {
